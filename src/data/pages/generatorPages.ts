...
export const GENERATOR_PAGES: Record<string, GeneratorPageData> = {
  ...
  "american-name-generator": {
    ...
    examples: [
      { name: "Olivia Bennett", tag: "Classic Grace", description: "Peace and olive tree paired with blessed ancestry." },
      { name: "Jackson Miller", tag: "Modern Strong", description: "Son of Jack paired with historic agrarian miller roots." },
    ],
    tips: [
      { title: "Blend Modern with Vintage", desc: "American naming frequently pairs vintage given names (Harper, Evelyn) with classic surnames." },
    ],
    faqs: [
      { question: "Are these names based on real US baby census data?", answer: "Yes, based on official Social Security Administration top name trends." },
    ],
    relatedSlugs: ["british-name-generator", "random-full-name-generator", "male-name-generator"],
  },
  ...
  "irish-name-generator": {
    ...
    examples: [
      { name: "Finn O’Connor", tag: "Mythological Hero", description: "Fair warrior paired with descendant of champion hound." },
      { name: "Saoirse Murphy", tag: "Freedom & Sea", description: "Liberty paired with the historic sea warrior clan." },
    ],
    tips: [
      { title: "Pronunciation Guide", desc: "Saoirse is pronounced SEER-sha; Cillian is KILL-ee-an; Niamh is NEEV." },
    ],
    faqs: [
      { question: "Are Irish spellings authentic?", answer: "Yes, our database includes authentic Gaelic spellings and translations." },
    ],
    relatedSlugs: ["scottish-name-generator", "british-name-generator", "fantasy-name-generator"],
  },
  ...
  "scottish-name-generator": {
    ...
    examples: [
      { name: "Callum MacLeod", tag: "Highland Clan", description: "Peaceful dove paired with son of Leod clan designation." },
      { name: "Fiona Campbell", tag: "Fair & Resolute", description: "Fair white one paired with quick-witted clan roots." },
    ],
    tips: [
      { title: "Honor Clan Associations", desc: "Scottish surnames historically indicated allegiance to regional chieftains." },
    ],
    faqs: [
      { question: "Can I generate Scottish Gaelic names?", answer: "Yes, Scottish Gaelic and Scots variants are fully supported." },
    ],
    relatedSlugs: ["irish-name-generator", "british-name-generator", "medieval-name-generator"],
  },
  ...
  "chinese-name-generator": {
    ...
    examples: [
      { name: "Wei Zhang", tag: "Greatness & Archer", description: "Greatness and power paired with archer bow lineage." },
      { name: "Mei-Ling Wang", tag: "Delicate Beauty", description: "Graceful jade tinkling with royal monarch surname." },
    ],
    tips: [
      { title: "Family Name First", desc: "In Chinese tradition, the surname comes first (Zhang Wei). In Western contexts it is often reversed." },
    ],
    faqs: [
      { question: "Are these names realistic for contemporary fiction?", answer: "Yes, based on widely used Chinese personal names and verified Romanizations." },
    ],
    relatedSlugs: ["japanese-name-generator", "korean-name-generator", "random-full-name-generator"],
  },
  ...
  "korean-name-generator": {
    ...
    examples: [
      { name: "Min-jun Kim", tag: "Clever & Golden", description: "Clever and talented paired with precious gold clan roots." },
      { name: "Seo-yeon Lee", tag: "Graceful Omen", description: "Felicitous omen paired with plum tree ancestry." },
    ],
    tips: [
      { title: "Hyphenated Given Names", desc: "Korean given names are often hyphenated in Roman script (Do-yun, Si-woo)." },
    ],
    faqs: [
      { question: "Are these names common in modern Korea?", answer: "Yes! They represent the most popular names registered in South Korea today." },
    ],
    relatedSlugs: ["japanese-name-generator", "chinese-name-generator", "random-full-name-generator"],
  },
  ...
  "russian-name-generator": {
    ...
    examples: [
      { name: "Nikolai Sokolov", tag: "Noble & Falcon", description: "Victory of the people with son of the falcon surname." },
      { name: "Elena Morozova", tag: "Radiant & Frost", description: "Radiant light paired with descendant of the winter frost." },
    ],
    tips: [
      { title: "Note Gendered Surname Endings", desc: "Female Russian surnames traditionally add an -a (Ivanov &rarr; Ivanova, Morozov &rarr; Morozova)." },
    ],
    faqs: [
      { question: "Can I generate names for historical 19th-century fiction?", answer: "Yes, our dataset includes timeless literary classics." },
    ],
    relatedSlugs: ["scandinavian-name-generator", "german-name-generator", "character-name-generator"],
  },
  ...
  "rpg-name-generator": {
    ...
    examples: [
      { name: "Thorgar Stonebreaker", tag: "Warrior Tank", description: "Crusher of fortress gates with unyielding resolve." },
      { name: "Astaroth Runeveil", tag: "Mystic Diviner", description: "Scholar of ancient fate and celestial omens." },
    ],
    tips: [
      { title: "Match Alignment to Tone", desc: "Lawful good paladins suit noble Latinate names; chaotic rogues thrive with sharp, short monikers." },
    ],
    faqs: [
      { question: "Can I use these for tabletop and video games?", answer: "Yes, compatible with D&D, Pathfinder, WoW, Skyrim, and tabletop systems." },
    ],
  ...
  "gaming-name-generator": {
    ...
    examples: [
      { name: "VortexTitan", tag: "Competitive FPS", description: "Heavyweight presence in tournament lobbies." },
      { name: "PixelSlayer", tag: "Retro / Action", description: "Agile, sharp, and instantly recognizable." },
    ],
    tips: [
      { title: "Keep It Pronounceable", desc: "Make sure teammates can easily call your name out during high-stress matches." },
    ],
    faqs: [
      { question: "Will these work across all major gaming platforms?", answer: "Yes, they comply with standard alphanumeric length restrictions." },
    ],
    relatedSlugs: ["gamer-name-generator", "username-generator", "minecraft-name-generator"],
  },
  ...
  "nickname-generator": {
    ...
    examples: [
      { name: "TurboBadger", tag: "Energetic & Fun", description: "Tenacious and unstoppable with a sense of humor." },
      { name: "ChillFox", tag: "Relaxed & Clever", description: "Smooth, cunning, and approachable." },
    ],
    tips: [
      { title: "Use Animal Imagery", desc: "Animals evoke immediate personality traits (loyal canine, swift falcon, cunning fox)." },
    ],
    faqs: [
      { question: "Are these nicknames family-friendly?", answer: "Yes, strictly moderated and safe for all age groups." },
    ],
    relatedSlugs: ["random-username-generator", "username-generator", "cute-names-generator"],
  },
  ...
  "brand-name-generator": {
    ...
    examples: [
      { name: "Echo Collective", tag: "Creative Studio", description: "Compelling stories shaped through multimedia design." },
      { name: "Urban Grain Co.", tag: "Artisanal Goods", description: "Timeless handcrafted goods for modern mindful living." },
    ],
    tips: [
      { title: "Evoke Sensory Imagery", desc: "Brands with tactile vocabulary (Velvet, Grain, Light) resonate deeply with consumers." },
    ],
    faqs: [
      { question: "Can I use these brand names commercially?", answer: "Yes, free to use. Conduct standard trademark searches before registering." },
    ],
    relatedSlugs: ["business-name-generator", "startup-name-generator", "company-name-generator"],
  },
  ...
  "rare-names-generator": {
    ...
    examples: [
      { name: "Persephone", tag: "Mythological Greek", description: "Queen of the underworld; mystical and powerful." },
      { name: "Cassander", tag: "Ancient Hellenic", description: "Brother to Alexander the Great’s legacy; majestic and rare." },
    ],
    tips: [
      { title: "Pair Rare First Names with Grounded Surnames", desc: "An unusual given name paired with a familiar surname creates believable contrast." },
    ],
    faqs: [
      { question: "Are rare names difficult to pronounce?", answer: "We select rare names that remain melodically natural and phonetic." },
    ],
    relatedSlugs: ["unique-names-generator", "cool-names-generator", "fantasy-name-generator"],
  },
};
