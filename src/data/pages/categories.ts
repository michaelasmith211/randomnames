...
export const CATEGORY_GROUPS: CategoryGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'RPG Name Generator', slug: 'rpg-name-generator', description: 'Tabletop RPG and campaign character names.' },
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'Gaming Name Generator', slug: 'gaming-name-generator', description: 'Competitive esports handles and multiplayer squad tags.' },
      ...
      { title: 'Nickname Generator', slug: 'nickname-generator', description: 'Catchy, affectionate, and quirky nicknames for companions.' },
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'Brand Name Generator', slug: 'brand-name-generator', description: 'Creative agency, studio, and product brand names.' },
    ],
  },
  {
    id: 'countries',
    ...
    icon: 'Globe',
    items: [
      { title: 'American Name Generator', slug: 'american-name-generator', description: 'Contemporary & classic American first and last names.' },
      ...
      { title: 'Irish Name Generator', slug: 'irish-name-generator', description: 'Traditional Celtic and Gaelic first names with historic clan surnames.' },
      { title: 'Scottish Name Generator', slug: 'scottish-name-generator', description: 'Highland clan names, lochs, and historic Scottish tartans.' },
      ...
      { title: 'Chinese Name Generator', slug: 'chinese-name-generator', description: 'Auspicious, balanced Chinese given names and Baijiaxing family surnames.' },
      { title: 'Korean Name Generator', slug: 'korean-name-generator', description: 'Contemporary, melodious Hangul names and traditional family clans.' },
      { title: 'Russian Name Generator', slug: 'russian-name-generator', description: 'Slavic, imperial, and contemporary Russian names with historical patronymics.' },
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'Rare Names Generator', slug: 'rare-names-generator', description: 'Uncommon, mysterious, and forgotten historical gems outside top charts.' },
